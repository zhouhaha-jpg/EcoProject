...
export function buildTwinSceneSnapshot({
  ...
  const flows: TwinFlow[] = [
    createFlow({
      ...
      medium: 'power',
      popupPosition: [-6.4, 5.3, -4.2],
      focusTarget: [-5.6, 3.9, -4.1],
      focusCamera: [-1.8, 8.6, 4.2],
      color: TWIN_COLORS.energy,
      value: pvPower,
      direction: 1 as const,
      status: deviceDetails['pv-field']?.status ?? 'normal',
      points: [[-18.2, 1.6, -7.2], [-17.6, 4.1, -8.9], [-11.8, 5.7, -8.4], [-4.2, 5.9, -5.2], [1.8, 4.8, -2.1], [8, 2.6, 0.8]],
    }),
    createFlow({
      id: 'gm-hub',
      from: 'gm-unit',
    ...
    createFlow({
      ...
      points: [[24.1, 1.8, -2.1], [23.8, 4.2, 0.5], [20.6, 4.8, 1.4], [16.2, 4.4, 1.6], [11.6, 3.6, 1.2], [8, 2.6, 0.8]],
    }),
    createFlow({
      id: 'hub-ca',
      from: 'hub-core',
